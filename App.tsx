...
const DEFAULT_PRESETS: PromptPreset[] = [
  {
    ...
    isDefault: true,
    maxDuration: 12,
    instruction: `Role: Expert FPV Drone Cinematographer.
Objective: Identify smooth, continuous "flow" lines and artistic maneuvers.
Task: Extract timestamps for cinematic moves like slow proximity rolls, cliff dives, and large power loops. 
Ignore: Jittery movements, crashes, and technical setup.`
  },
  {
    id: 'social-shorts',
    ...
    isDefault: true,
    maxDuration: 6,
    instruction: `Role: Viral Content Editor.
Objective: Identify rapid-fire, high-energy "Gold" moments.
Task: Extract short, high-impact clips. Focus on "punchy" visuals: gap hits, fast rolls, or sudden dives.`
  },
  {
    id: 'technical',
    name: 'Gap & Technical Hunter',
    isDefault: true,
    maxDuration: 8,
    instruction: `Role: Technical FPV Pilot.
Objective: Identify small gap hits, tight proximity flying, and complex technical combos.
Task: Focus on high-precision flying. Extract moments where the drone passes through small openings or performs rapid directional changes.`
  },
  {
    id: 'crash',
    ...
    isDefault: true,
    maxDuration: 5,
    instruction: `Role: FPV Safety Inspector.
Objective: Find every collision, close-call, or landing.
Task: Extract timestamps specifically for crashes, "fails", or near-misses. Rate the intensity (score) based on impact force.`
  }
];
